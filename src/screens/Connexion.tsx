...
export default function Connexion() {
  ...
  //  Génère un nonce une seule fois au montage
  useEffect(() => {
  ...
  const [request, response, promptAsync] = useAuthRequest(
    {
      clientId:
        "665570993787-p9st3nhjsbhgm8o0ao5vllvm1rplhk14.apps.googleusercontent.com",
      redirectUri,
  ...
  //  Fonction pour connecter Firebase une seule fois
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          if (!request) return;
          console.log("▶️ Lancement de Google OAuth...");
